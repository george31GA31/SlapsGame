...
(() => {
 ...
 addEventListener('load',()=>{
  ...
  const refresh=()=>{mine.textContent=gameState.myName||'YOU';opponent.textContent=gameState.opponentName||params.get('opponent')||'BOT';ready.disabled=!gameState.playerHand.length;ready.textContent=ready.disabled?'Connecting…':'Ready to play';};
